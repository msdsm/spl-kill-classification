...
def main():
    parameters_saved_path = "./pth_file/20221203-2.pth"
    parameters_load_path = "./pth_file/20221203.pth"
    ...
    x = torch.load("pt_file/train_preprocess_input_data.pt")
    t = torch.load("pt_file/train_preprocess_input_label.pt")
    x = x.to("cuda")
    t = t.to("cuda")
    print(x.size())
    print(t.size())
